...
class PID(object):
	...
	def get_steering_angle(self):
		...
		steer_positional_diff = math.atan2(self.target_pose.position.y - self.current_pose.position.y, abs(self.target_pose.position.x) - self.current_pose.position.x)
